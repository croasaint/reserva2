...
<h1 class="col-12 mb-5"><?= $service_name?></h1>
<p><?= $service_description?></p>
<?php if($this->session->userdata('rol') == '1'){ ?>
<h2 class="col-12 mb-4">Agregar Recurso</h2>
<?php echo form_open('resource'); ?>
  ...
  <button type="submit" class="btn btn-primary mb-5 col-2">Enviar</button>
<?php echo form_close(); ?>
<?php } ?>
...
<h2 class="col-12">Listado de Recursos</h2>
